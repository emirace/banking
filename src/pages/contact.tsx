...
const Contact = () => {
  ...
  return (
    <div className="">
      <Navbar />
      <section className="bg-gradient-to-br from-purple-900 pt-20 h-72  via-black to-blue-600 text-white flex w-full justify-center items-center ">
        <h1 className="text-5xl md:text-7xl font-semibold">Contact Us</h1>
      </section>
      <section className="px-6 py-12 max-w-6xl w-full mx-auto">
      ...
      <section className=" py-12 flex flex-col md:flex-row items-center gap-10 mb-16 max-w-6xl w-full mx-auto">
        {/* Left Image */}
        <img
          src={contactimage}
          alt="Traveler"
